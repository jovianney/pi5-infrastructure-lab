# 13 — Virtual Firewall Lab: VirtualBox Network Segmentation
...
![labnet adapter config](13-virtual-firewall-lab-labnet-adapter-config.png)

**FirewallVM first successful login after install**
![Firewall first boot](13-virtual-firewall-lab-firstboot-AFTER.png)

**Clean reboot after disabling cloud-init (boot hang fix)**
![cloud-init fix verified](13-virtual-firewall-lab-cloudinit-fixed-AFTER.png)

**NAT working — internet access through the firewall**
![NAT success](13-virtual-firewall-lab-nat-success-AFTER.png)

**Isolation confirmed — internet allowed, home network blocked**
![Isolation confirmed](13-virtual-firewall-lab-isolation-confirmed-AFTER.png)
